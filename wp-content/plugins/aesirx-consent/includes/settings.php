...
add_action('admin_init', function () {
  ...
  add_settings_field(
    ...
    __('Consent Template', 'aesirx-analytics'),
    function () {
      $checked = 'checked="checked"';
      $template = get_option('aesirx_analytics_plugin_options_datastream_template') ?? "default";
      // using custom function to escape HTML
      echo '<table id="aesirx-analytics-consent-template">';
      echo  '<tr>';
      echo    '<td>';
      echo "<img src='". plugins_url( 'aesirx-consent/assets/images-plugin/consent_default.png')."' />";
      echo aesirx_analytics_escape_html('<label>' . esc_html__('Default template', 'aesirx-analytics') . ' <input type="radio" class="analytic-consent-class" name="aesirx_analytics_plugin_options_datastream_template" ' .
      ($template == 'default' ? $checked : '') .
      ' value="default"  /></label>');
      echo aesirx_analytics_escape_html("<p class='description'><strong>".esc_html__('Description', 'aesirx-analytics').": </strong>".esc_html__("AesirX Consent Management is improving Google Consent Mode 2.0 by not loading any tags until after consent is given reducing the compliance risk.", 'aesirx-analytics')."</p>");
      echo    '</td>';
      echo    '<td>';
      echo "<img src='". plugins_url( 'aesirx-consent/assets/images-plugin/consent_simple_mode.png')."' />";
      echo aesirx_analytics_escape_html('<label>' . esc_html__('Simple Consent Mode', 'aesirx-analytics') . ' <input type="radio" class="analytic-consent-class" name="aesirx_analytics_plugin_options_datastream_template" ' .
  ...
  add_settings_field(
    ...
    esc_html__('Gtag ID', 'aesirx-analytics'),
    function () {
  ...
  add_settings_field(
    ...
    esc_html__('GTM ID', 'aesirx-analytics'),
    function () {
  ...
  add_settings_section(
    ...
    function () {
      ...
      <a target='_blank' href='https://aesirx.io/documentation'><img src='". plugins_url( 'aesirx-consent/assets/images-plugin/icon_button.svg')."' />".esc_html__('ACCESS THE DOCUMENTATION HUB', 'aesirx-analytics')."</a></div>");
    },
    'aesirx_analytics_info'
  );
