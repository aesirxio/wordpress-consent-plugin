    ...
    Class AesirxAnalyticsMysqlHelper
    {
        public function aesirx_analytics_get_list($sql, $total_sql, $params, $allowed, $bind) {
            ...
            try {
                ...
                return new WP_Error('database_error', esc_html__('Database error occurred.', 'aesirx-consent'), ['status' => 500]);
            }
        }
        ...
        function aesirx_analytics_validate_domain($url) {
            ...
            if ($parsed_url === false || !isset($parsed_url['host'])) {
                return new WP_Error('validation_error', esc_html__('Domain not found', 'aesirx-consent'), ['status' => 400]);
            }
        ...
        function aesirx_analytics_add_visitor_consent($visitor_uuid, $consent_uuid = null, $consent = null, $datetime = null, $expiration = null, $params = [], $tier = "level1") {
            ...
            if ($wpdb->last_error) {
                return new WP_Error('db_insert_error', esc_html__('Could not insert consent', 'aesirx-consent'), ['status' => 500]);
            }
        ...
        function aesirx_analytics_validate_string($nonce, $wallet, $singnature) {
            ...
            if (is_wp_error($response)) {
                ...
                return new WP_Error('validation_error', esc_html__('Something went wrong', 'aesirx-consent'));
            }
        ...
        function aesirx_analytics_expired_consent($consent_uuid, $expiration) {
            ...
            try {
                ...
                return new WP_Error('db_update_error', esc_html__('There was a problem updating the data in the database.', 'aesirx-consent'), ['status' => 500]);
            }
        }
