...
Class AesirX_Analytics_Add_Consent_Level6 extends AesirxAnalyticsMysqlHelper
{
    /**
    ...
    function aesirx_analytics_mysql_execute($params = [])
    {
        ...
        $expiration = gmdate('Y-m-d H:i:s', strtotime('+6 months', strtotime($now)));
